...
namespace CacheCardsPrototype
{
    public partial class ModifyFlashCards : Form
    {
        ...
        private void createButton_Click(object sender, EventArgs e)
        {
            ...
            else if (frontTextbox.Text.Length == 0 || backTextbox.Text.Length == 0)
            {
                MessageBox.Show("The card shoudl not be empty!");
                return;
            }
            // insert card
        ...
        private void frontTextbox_TextChanged(object sender, EventArgs e)
        {
        ...
        {
            if (frontTextbox.Text.Length == 0 || backTextbox.Text.Length == 0)
            {
                MessageBox.Show("The card should not be empty!"); 
                return;
            }
